...
pub(super) fn subscription_request_prompt(request: &MessagesRequest) -> String {
    format!(
        concat!(
            ...
            "parallelism. When launching multiple independent workers, emit every intended ",
            ...
            "can continue or the task must outlive the turn. For a related follow-up, use SendMessage ",

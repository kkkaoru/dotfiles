...
impl AgentEffortIntents {
    ...
    pub(in crate::anthropic) fn remove_tool_results<'a>(&self, tool_use_ids: impl Iterator<Item = &'a str>) {
    ...
    pub(in crate::anthropic) fn retire_terminal_task_notifications(&self, request: &MessagesRequest) {

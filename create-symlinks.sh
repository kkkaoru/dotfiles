...
for package in pi-effort-manager pi-my-clinepass-provider pi-my-cursor-provider pi-my-devin-cli-provider pi-claudex-provider pi-lazy-external-extensions executor-skills; do
